...
public class InterfazEliminarLibro extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InterfazEliminarLibro frame = new InterfazEliminarLibro();
	...
	public InterfazEliminarLibro() {
		...
		setContentPane(contentPane);
		{
			...
			contentPane.add(panel, BorderLayout.CENTER);
			{
				...
				lblISBN.setBounds(46, 130, 46, 14);
				panel.add(lblISBN);
			}
			{
				txtISBN = new JTextField();
				txtISBN.setColumns(10);
				txtISBN.setBounds(102, 127, 86, 20);
				panel.add(txtISBN);
			}
			{
			...
			}
			{
					...
					public void actionPerformed(ActionEvent e) {
						if(txtISBN.getText()==null){
							...
							try {
								...
								g.eliminarLibro(txtISBN.getText());
				...
				btnEliminarLibro.setBounds(224, 126, 117, 23);
			...
			}
			{
				...
				btnAtras.setBounds(224, 171, 117, 23);
				panel.add(btnAtras);
			}
		}
	}
